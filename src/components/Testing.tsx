...
const Testing = () => {
  ...
  return (
    <Container>
        <Title title="Try it" />
        <p className='text-sm my-5'>Run this code here, in a console or from any site:</p>
        ...
        <button onClick={() => setTest(true)} className='my-5 bg-black text-gray-200 text-sm font-semibold py-2 px-4 rounded-md hover:bg-black/80 hover:text-white duration-200 cursor-pointer'>Run script</button>
        ...
        {test && (
            <p className='text-sm font-medium mt-5'>Congrats! You&apos;ve made your first call to JSONPlaceholder.
                😄 🎉
            </p>
        )}
    </Container>
